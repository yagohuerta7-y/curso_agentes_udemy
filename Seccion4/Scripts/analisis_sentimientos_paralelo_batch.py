# Este script completa el proceso de paralelizar el proceso
# Ya se usa el llamada de batch
...
def main():
    ...
    # Este nuevo proceso acelera esto mucho, pues con lo que se tardaba en uno, lo hizo con todos
